                        ...
                        <div class="row">
                            {{-- <div class="col-sm-4">
                                <div class="tg-footercol">
                                    ...
                                    <div class="tg-description">
                                        <p>Adipisicing elit, sed do eiusmod tempor incidunta utiai labore et dolore
                                            magna si aliqua quis.</p>
                                    </div>
                                    ...
                                    <div class="tg-toprated">
                                        <ul>
                                            <li>
                                                <figure>
                                                    <a href="#">
                                                        <img src="images/thumbnails/img-04.jpg"
                                                            alt="image description">
                                                    </a>
                                                </figure>
                                                <div class="tg-productcontent">
                                                    <h4><a href="#">Player 1</a></h4><span
                                            ...
                                            <li>
                                                <figure>
                                                    <a href="#">
                                                        <img src="images/thumbnails/img-05.jpg"
                                                            alt="image description">
                                                    </a>
                                                </figure>
                                                <div class="tg-productcontent">
                                                    <h4><a href="#">Player 2</a></h4><span
                                                        class="tg-stars"><span></span></span>
                                                    <span class="tg-price">Price: $67</span>
                                                </div>
                                            </li>
                                            <li>
                                                <figure>
                                                    <a href="#">
                                                        <img src="images/thumbnails/img-06.jpg"
                                                            alt="image description">
                                                    </a>
                                                </figure>
                                                <div class="tg-productcontent">
                                                    <h4><a href="#">Player 3</a></h4><span
                                                        class="tg-stars"><span></span></span>
                                                    <span class="tg-price">Price: $67</span>
                                                </div>
                                            </li>
                                            <li>
                                                <figure>
                                                    <a href="#">
                                                        <img src="images/thumbnails/img-07.jpg"
                                                            alt="image description">
                                                    </a>
                                                </figure>
                                                <div class="tg-productcontent">
                                                    <h4><a href="#">Player 4</a></h4><span
                                                        class="tg-stars"><span></span></span>
                                                    <span class="tg-price">Price: $67</span>
                                                </div>
                                            </li>
        ...
        <div class="modal-dialog" role="document">
            <div class="tg-modal-content">
                <div class="tg-formarea">
                    ...
                    <form class="tg-loginform" method="post" id="loginForm" action="{{ route('login.perform') }}">
                        @csrf
                        @method('post')
                        <fieldset>
                ...
                <div class="tg-formarea">
                    ...
                    <form class="tg-loginform" id="registerForm" method="post"
                        ...
                        <fieldset>
                            ...
                            {{-- @if ($errors->has('email')) --}}
                            <span class="text-danger" id="email_error"></span><br>
                            {{-- @endif --}}
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button class="tg-btn tg-btn-lg" type="button" onclick="registerUser()">Singup
                                    Now</button>
                            </div>
                            <div class="tg-description">
                                <p>Already have an account? <a href="javascript().html" data-toggle="modal"
                                        data-target="#tg-login">Login</a></p>
                            </div>
                        </fieldset>
                    </form>
                </div>
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    ...
                    if (errors.hasOwnProperty('username')) {
                        $('#name_error').text(errors.username[0]);
                    }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        $('#login_email_error').text(response.email)
                    }
                },
                error: function(xhr, status, error) {
                    $('#login_password_error').text('')
